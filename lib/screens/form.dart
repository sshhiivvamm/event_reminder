              ...
              child: Column(
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    style: TextStyle(
                      color: EventColors.white, // Selected item text color
                    ...
                    hint: Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 18,
                          color: EventColors.black, // Hint text color
                        ),
                      ),
                    ),
                        ...
                        return DropdownMenuItem<String>(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              value,
                              style: TextStyle(
                                color: EventColors.black, // Item text color
                      ...
                      DropdownMenuItem<String>(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              color:
                                  EventColors.black, // "Other" item text color
                              fontSize: 16, // Adjust text size
                            ),
                          ),
                        ),
                      ...
                      return FormUtils.dropdownItems.map<Widget>((String item) {
                        return Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              color:
                                  EventColors.black, // Text color when selected
                              fontSize: 16, // Adjust text size
                            ),
                          ),
                        );
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor: EventColors.pgreen),
                        onPressed: () {},
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text(
                              'Save',
                              style: TextStyle(
                                  fontSize: 20, color: EventColors.textcolor),
                            ),
                            SizedBox(
                              width: 10,
                            ),
